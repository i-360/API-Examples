...
{
    [TestClass]
    public class SearchParametersIntegrationTests
    {
        ...
        {
            new KeyValuePair<HttpMethod, string>(HttpMethod.Get, "SearchParameters"),
            new KeyValuePair<HttpMethod, string>(HttpMethod.Get, "SearchParameters/2")
        };
